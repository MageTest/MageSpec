...
class ModelResourceSpec extends ObjectBehavior
{
    ...
    {
        $this->beConstructedWith(array('VendorName', 'ModuleName', 'ModelName'), $locator);
    }
    ...
    {
        $this->getName()->shouldReturn('VendorName_ModuleName_ModelName');
    }

    function it_appends_Spec_suffix_to_name__as_specName()
    {
        $this->getSpecName()->shouldReturn('VendorName_ModuleName_ModelNameSpec');
    }
    ...
    {
        $this->getSrcClassname()->shouldReturn('VendorName_ModuleName_ModelName');
    }
    ...
    function it_generates_spec_classname_from_provided_parts_using_locator($locator)
    {
        ...
        $this->getSpecClassname()->shouldReturn('spec\VendorName_ModuleName_ModelNameSpec');
    }
}
