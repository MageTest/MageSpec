...
class ModelResourceSpec extends ObjectBehavior
{
    ...
    function it_generates_src_filename_from_provided_parts_using_locator($locator)
    {
        ...
        $this->getSrcFilename()->shouldReturn(DirectorySeparator::replacePathWithDirectorySeperator('/app/code/local/VendorName/ModuleName/Model/ModelName.php'));
    }
    ...
    function it_generates_spec_filename_from_provided_parts_using_locator($locator)
    {
        ...
        $this->getSpecFilename()->shouldReturn(DirectorySeparator::replacePathWithDirectorySeperator('/spec/VendorName/ModuleName/Model/ModelNameSpec.php'));
    }
