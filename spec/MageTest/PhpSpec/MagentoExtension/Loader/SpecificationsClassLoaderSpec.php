 ...
 */
namespace spec\MageTest\PhpSpec\MagentoExtension\Loader;
 ...
 */
class SpecificationsClassLoaderSpec extends ObjectBehavior
{
    ...
    function it_checks_if_controller_spec_implements_magespec_controller_behavior()
    {
        ...
        $specifications[0]
            ->getClass()
            ->isSubclassOf('MageTest\PhpSpec\MagentoExtension\Specification\ControllerBehavior')
            ->shouldBe(true);
    }
    ...
    function it_checks_if_block_spec_implements_magespec_block_behavior()
    {
        ...
        $specifications[0]
            ->getClass()
            ->isSubclassOf('MageTest\PhpSpec\MagentoExtension\Specification\BlockBehavior')
            ->shouldBe(true);
    }
