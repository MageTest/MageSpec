...
namespace MageTest\PhpSpec\MagentoExtension\Wrapper\Subject;
...
class VarienCaller extends Caller
{
    /**
     * @var WrappedObject
     */
    ...
    private $dispatcher;
    /**
     * @var \MageTest\PhpSpec\MagentoExtension\Wrapper\VarienWrapper
     */
    private $wrapper;
    /**
